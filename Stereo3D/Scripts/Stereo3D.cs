...
//            CameraStackSet();
    ...
    void Start()
    {
        ...
        //if (method == Method.Two_Cables) //prevent disabled post process with Method.Two_Cables at start
        //    OnOffToggle();
    }
    ...
    void Update()
    {
        ...
        {
            if (lastMethod == Method.Two_Cables)
